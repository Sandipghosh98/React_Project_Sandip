                ...
                <div class="ui grid">
                    {this.props.up.map ((sub) => {
                        return (
                            ...
                            <div class="four wide column" id="datestyle" key={sub.date.iso}
                                 onClick={this.do.bind (this, sub.date.datetime.day, sub.date.datetime.month, sub.date.datetime.year, sub.date.iso)}>{sub.date.datetime.day}
