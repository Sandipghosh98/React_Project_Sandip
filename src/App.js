...
//   }
    ...
    render() {
            ...
            return <div class="ui ">
                <div class="ui active inverted dimmer">
                    <div class="ui text loader"
                         style={{textAlign: 'center', marginTop: '50px', fontSize: "50px"}}>Loading...
                    </div>
                </div>
        ...
        if (this.state.error) {
            return <div style={{textAlign: 'center', marginTop: '300px', fontSize: "50px"}}><i
                class="exclamation triangle icon big"></i>Error Loading Data</div>
        }
        return (
            <div className="Apppp">
                {/* <Current /> */}
                ...
                <br></br>
                <div className="btn">
                    <button className="ui button" id="button-style" onClick={this.onFromSubmitted}>Upcomming Holidays
                    </button>
                    <button className="ui button" id="button-style" onClick={this.onFromSubmitted1}>Passed Holidays
                    </button>
